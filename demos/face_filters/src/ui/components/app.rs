use crate::{
    ui::graphics::{
        AttributeId, BufferId, create_vertex_buffer,
        create_frame_buffer,
        create_position_attribute,
        create_face_filters_texture, FragmentShaderId,
        FramebufferId, ProgramId, render,
        TextureId, UniformId, VertexShaderId,
    },
    ui::state::{RenderState, RenderStateHandle},
};
    ...
    use_effect_with_deps(
        {
            ...
            move |_| {
                ...
                let mut face_filters_program_link = ProgramLinkBuilder::new();
                face_filters_program_link
                    .set_vertex_shader_id(VertexShaderId::Quad)
                    .set_program_id(ProgramId::SimplexNoise)
                    .set_fragment_shader_id(FragmentShaderId::SimplexNoise);
                let face_filters_program_link = face_filters_program_link
                    .build()
                ...
                let face_filters_texture_link =
                    TextureLink::new(TextureId::SimplexNoise, create_face_filters_texture);

                let u_face_filters_texture = UniformLink::new(
                ...
                let face_filters_framebuffer_link = FramebufferLink::new(
                ...
                renderer_data_builder
                    ...
                    .add_program_link(face_filters_program_link)
                    .add_buffer_link(vertex_buffer_link)
                    .add_attribute_link(a_position_link)
                    .add_uniform_link(u_now)
                    .add_uniform_link(u_face_filters_texture)
                    .add_texture_link(face_filters_texture_link)
                    .add_framebuffer_link(face_filters_framebuffer_link)
